      ...
      <main className="flex-grow relative w-full bg-background-main text-text-main font-pixel min-h-screen overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-4 md:px-6 py-12 lg:py-20">
          ...
          {!googleUser ? (
            ...
            registrationData?.["Selected"] === "TRUE" ? (
              <div className="bg-surface-card border-2 border-green-500/30 p-6 md:p-10 flex flex-col items-center text-center gap-6">
                <div className="relative">
                  ...
                  <span className="material-symbols-outlined text-7xl text-green-400 relative">celebration</span>
                </div>
                <h2 className="font-pixel text-2xl md:text-3xl text-green-400 uppercase tracking-widest">Congrats!!</h2>
                <div className="font-pixel text-lg md:text-xl text-white/70 max-w-2xl flex flex-col items-center gap-4">
                  ...
                  <p className="text-base text-white/80 mt-2 leading-relaxed">
                    Further details regarding reporting time and venue will be shared through WhatsApp and Email.
                  </p>
                  <p className="text-base text-white/80 leading-relaxed">
                    Please <Link href="/sih" className="text-secondary hover:underline">regularly check the website</Link> and carefully go through the rules and regulations to be followed during the hackathon.
                  </p>
                </div>
                <Link
                  href="/sih"
            ...
            ) : registrationData?.["Selected"] === "FALSE" ? (
              <div className="bg-surface-card border-2 border-white/20 p-6 md:p-10 flex flex-col items-center text-center gap-6">
                <span className="material-symbols-outlined text-7xl text-white/50">info</span>
                <h2 className="font-pixel text-2xl md:text-3xl text-white/70 uppercase tracking-widest">Sorry!</h2>
                <div className="font-pixel text-lg md:text-xl text-white/70 max-w-2xl flex flex-col items-center gap-4">
                  {registrationData && (
                    <div className="border-2 border-white/10 bg-background-main/50 p-6 flex flex-col gap-3 rounded max-w-md w-full text-left">
                      <div className="flex justify-between border-b border-white/10 pb-2 gap-4">
                        <span className="text-white/40 uppercase tracking-wider text-sm">Team Name</span>
                        <span className="text-white/70 font-bold text-right">{registrationData["Team Name"]}</span>
                      </div>
                      <div className="flex justify-between gap-4">
                        <span className="text-white/40 uppercase tracking-wider text-sm">Leader Name</span>
                        <span className="text-white/70 font-bold text-right">{registrationData["Leader Name"]}</span>
                      </div>
                    </div>
                  )}
                  <p className="text-base text-white/60 mt-2 leading-relaxed">
                    We sincerely appreciate your participation! Due to the exceptionally high volume of competitive entries this year, we had to make some very difficult decisions and unfortunately could not select your team.
                  </p>
                  <p className="text-base text-white/60 leading-relaxed">
                    We will be hosting more hackathons and events in the future. Stay connected with us through our social channels to be the first to know!
                  </p>
                  <div className="flex gap-6 mt-4">
                    <a href="https://chat.whatsapp.com/EMAVIAzhTjtI5J6FsQyx6I" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/40 hover:text-green-500 transition-colors group">
                       ...
                       <span className="font-sans text-sm uppercase tracking-widest">WhatsApp</span>
                    </a>
                    <a href="https://www.instagram.com/ig_nitw/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/40 hover:text-pink-500 transition-colors group">
                       ...
                       <span className="font-sans text-sm uppercase tracking-widest">Instagram</span>
                    </a>
                    <a href="https://www.linkedin.com/company/ig-nitw/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/40 hover:text-blue-500 transition-colors group">
                       ...
                       <span className="font-sans text-sm uppercase tracking-widest">LinkedIn</span>
                    </a>
                  </div>
                </div>
                <Link
                  href="/sih"
                  className="inline-flex items-center gap-3 bg-white/10 text-white font-pixel text-xl uppercase tracking-widest px-8 py-4 hover:bg-white/20 transition-all duration-200 border border-white/20"
                >
                  Go to SIH Dashboard
                </Link>
              </div>
