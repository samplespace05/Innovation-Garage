...
export default function Ideas() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      // 🟢 UPDATED: Use the Universal Gateway
      const res = await fetch("/api/admin", {
        ...
        body: JSON.stringify({
          action: "saveIdea", // <--- CRITICAL: Tells Google Script this is an Idea Submission
          ...rawData // Spreads all form fields (fullName, email, etc.)
        })
      });
