    ...
    <footer className="w-full border-t border-white/10 bg-cyber-black py-12 px-6 relative z-10 text-warm-white font-pixel">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4">
            <a href="#" aria-label="LinkedIn" className="w-12 h-12 flex items-center justify-center border border-white/20 bg-surface-card text-gray-400 hover:border-[#0077B5] hover:text-[#0077B5] hover:shadow-[0_0_10px_#0077B5] transition-all group pixel-corners">
            ...
            <a href="#" aria-label="Instagram" className="w-12 h-12 flex items-center justify-center border border-white/20 bg-surface-card text-gray-400 hover:border-[#E1306C] hover:text-[#E1306C] hover:shadow-[0_0_10px_#E1306C] transition-all group pixel-corners">
            ...
            <a href="#" aria-label="WhatsApp" className="w-12 h-12 flex items-center justify-center border border-white/20 bg-surface-card text-gray-400 hover:border-[#25D366] hover:text-[#25D366] hover:shadow-[0_0_10px_#25D366] transition-all group pixel-corners">
